<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('releases.index')" :active="request()->routeIs('releases.*') && !request()->routeIs('releases.minha-area')">
                        📋 Releases Públicas
                    </x-nav-link>
                    
                    @auth
                        <x-nav-link :href="route('releases.minha-area')" :active="request()->routeIs('releases.minha-area')">
                            👤 Minha Área
                        </x-nav-link>
                        
                        @can('access-analista')
                            <x-nav-link :href="route('admin.releases.index')" :active="request()->routeIs('admin.*')">
                                ⚙️ Administração
                            </x-nav-link>
                        @endcan
                    @endauth
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('releases.index')" :active="request()->routeIs('releases.*') && !request()->routeIs('releases.minha-area')">
                📋 Releases Públicas
            </x-responsive-nav-link>
